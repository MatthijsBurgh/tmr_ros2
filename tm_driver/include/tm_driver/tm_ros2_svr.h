...
public:
  bool connect_tmsvr(const std::shared_ptr<tm_msgs::srv::ConnectTM::Request>& req,
                     std::shared_ptr<tm_msgs::srv::ConnectTM::Response> res);

  bool write_item(const std::shared_ptr<tm_msgs::srv::WriteItem::Request>& req,
                  std::shared_ptr<tm_msgs::srv::WriteItem::Response> res);
  bool ask_item(const std::shared_ptr<tm_msgs::srv::AskItem::Request>& req,
