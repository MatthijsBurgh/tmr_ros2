...
public:
  explicit TmSctRos2(const rclcpp::Node::SharedPtr& node, TmDriver& iface, bool is_fake);
  ~TmSctRos2();

protected:
  void sct_msg(TmSctData data);
  void sta_msg(const std::string& subcmd, const std::string& subdata);

public:
  bool connect_tmsct(const std::shared_ptr<tm_msgs::srv::ConnectTM::Request>& req,
                     std::shared_ptr<tm_msgs::srv::ConnectTM::Response> res);

  bool send_script(const std::shared_ptr<tm_msgs::srv::SendScript::Request>& req,
                   std::shared_ptr<tm_msgs::srv::SendScript::Response> res);
  bool set_event(const std::shared_ptr<tm_msgs::srv::SetEvent::Request>& req,
                 std::shared_ptr<tm_msgs::srv::SetEvent::Response> res);
  bool set_io(const std::shared_ptr<tm_msgs::srv::SetIO::Request>& req,
              std::shared_ptr<tm_msgs::srv::SetIO::Response> res);
  bool set_positions(const std::shared_ptr<tm_msgs::srv::SetPositions::Request>& req,
                     std::shared_ptr<tm_msgs::srv::SetPositions::Response> res);

  bool ask_sta(const std::shared_ptr<tm_msgs::srv::AskSta::Request>& req,
