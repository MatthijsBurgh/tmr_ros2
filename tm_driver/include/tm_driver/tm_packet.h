...
public:
  ...
  bool is_checksum_failed()
  {
    return _is_cs_failed;
  }
...
public:
  ...
  static void build_TmSvrData(TmSvrData& data, const std::string& id, Mode mode, const char* content, size_t len,
                              SrcType type);
...
public:
  ...
  static void build_content(std::vector<char>& content, const std::array<float, 6>& angle,
...
public:
  ...
  static void build_TmStaData(TmStaData& data, const std::string& sub_cmd, const char* sub_data, size_t len,
                              SrcType type);
