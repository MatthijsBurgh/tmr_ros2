...
public:
  explicit TmSctCommunication(const std::string& ip, int recv_buf_len, bool& is_on_listen_node,
  ...
  void check_script_is_exit(const std::string& script);
...
public:
  TmCPError::Code cperr_code()
  {
    return tmSctErrData.error_code();
  }
