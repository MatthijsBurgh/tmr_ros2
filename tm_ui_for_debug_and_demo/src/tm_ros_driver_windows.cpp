...
{
  connect(rosPage.get(), SIGNAL(send_ui_feed_back_status(tm_msgs::msg::FeedbackState::SharedPtr)), this,
          SLOT(send_ui_feed_back_status(tm_msgs::msg::FeedbackState::SharedPtr)));
...
void MainWindow::set_text_true_false(bool isTrue, QLabel* label, bool isReverse)
{
  if (!isReverse)
  {
    if (isTrue)
    {
      label->setText("<html><head/><body><p><span style=\" font-size:14pt; font-weight:600; "
                     "color:#73d216;\">True</span></p></body></html>");
    }
    else
    {
      label->setText("<html><head/><body><p><span style=\" font-size:14pt; font-weight:600; "
                     "color:#cc0000;\">False</span></p></body></html>");
    }
  }
  else
  {
    ...
    {
      label->setText("<html><head/><body><p><span style=\" font-size:14pt; font-weight:600; "
                     "color:#cc0000;\">True</span></p></body></html>");
    }
    else
    {
      label->setText("<html><head/><body><p><span style=\" font-size:14pt; font-weight:600; "
                     "color:#73d216;\">False</span></p></body></html>");
    }
  }
}
...
void MainWindow::set_text_on_off(bool isTrue, QLabel* label, bool isReverse)
{
  if (!isReverse)
  {
    ...
    {
      label->setText("<html><head/><body><p><span style=\"font-size:14pt; font-weight:600; "
                     "color:#73d216;\">On</span></p></body></html>");
    }
    else
    {
      label->setText("<html><head/><body><p><span style=\"font-size:14pt; font-weight:600; "
                     "color:#fcaf3e;\">Off</span></p></body></html>");
    }
  }
  else
  {
    ...
    {
      label->setText("<html><head/><body><p><span style=\"font-size:14pt; font-weight:600; "
                     "color:#cc0000;\">On</span></p></body></html>");
    }
    else
    {
      label->setText("<html><head/><body><p><span style=\"font-size:14pt; font-weight:600; "
                     "color:#73d216;\">Off</span></p></body></html>");
    }
  }
}
...
void MainWindow::set_text_high_low(bool isTrue, QLabel* label, bool isReverse)
{
  if (!isReverse)
  {
    ...
    {
      label->setText("<html><head/><body><p><span style=\" font-size:14pt; font-weight:600; "
                     "color:#73d216;\">&nbsp;&nbsp;L</span></p></body></html>");
    }
    else
    {
      label->setText("<html><head/><body><p><span style=\" font-size:14pt; font-weight:600; "
                     "color:#73d216;\">&nbsp;&nbsp;H</span></p></body></html>");
    }
  }
  else
  {
...
void MainWindow::set_text_null_reserve(bool isTrue, QLabel* label)
{
  ...
  {
    label->setText("<html><head/><body><p><span style=\" font-size:14pt; font-weight:600; "
                   "color:#73d216;\">Null</span></p></body></html>");
  }
  else
  {
    label->setText("<html><head/><body><p><span style=\" font-size:14pt; font-weight:600; "
                   "color:#8F7A66;\">RSV</span></p></body></html>");
  }
}
...
void MainWindow::set_text_manual_auto(int isValue, QLabel* label)
{
  ...
  {  // 1:AUTO  2:MANUAL  0: None
    label->setText("<html><head/><body><p><span style=\" font-size:14pt; font-weight:600; "
                   "color:#73d216;\">MAN</span></p></body></html>");
  }
  else if (isValue == 1)
  {
    label->setText("<html><head/><body><p><span style=\" font-size:14pt; font-weight:600; "
                   "color:#2a52be;\">Auto</span></p></body></html>");
  }
  else
  {
    label->setText("<html><head/><body><p><span style=\" font-size:14pt; font-weight:600; "
                   "color:#73d216;\">None</span></p></body></html>");
  }
}
...
void MainWindow::set_text_zero_false(int isZero, QLabel* label)
{
  ...
  {
    label->setText("<html><head/><body><p><span style=\" font-size:14pt; font-weight:600; "
                   "color:#73d216;\">0</span></p></body></html>");
  }
  else
  {
    label->setText("<html><head/><body><p><span style=\" font-size:14pt; font-weight:600; "
