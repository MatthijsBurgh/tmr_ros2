...
#include <chrono>
#include <tm_robot_msgs/srv/techman_robot_command.hpp>
...
int main(int argc, char* argv[])
{
  ...
  auto client = node->create_client<tm_robot_msgs::srv::TechmanRobotCommand>("tm_send_command");
  ...
  auto request = std::make_shared<tm_robot_msgs::srv::TechmanRobotCommand::Request>();
