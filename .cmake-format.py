...
with section("parse"):  # noqa: F821
    ...
    additional_commands = {
        "cc_binary": {
            ...
            "kwargs": {
                "DEPS": "*",
                "INC": {"kwargs": {"INTERFACE": "*", "PRIVATE": "*", "PUBLIC": "*"}, "pargs": 0},
                "LIBDIRS": {"kwargs": {"INTERFACE": "*", "PRIVATE": "*", "PUBLIC": "*"}, "pargs": "*"},
                "PKGDEPS": "*",
        ...
        "cc_library": {
            "flags": ["STATIC", "SHARED"],
            "kwargs": {
                "DEPS": {"kwargs": {"INTERFACE": "*", "PRIVATE": "*", "PUBLIC": "*"}, "pargs": "*"},
                "INC": {"kwargs": {"INTERFACE": "*", "PRIVATE": "*", "PUBLIC": "*"}, "pargs": 0},
                "LIBDIRS": {"kwargs": {"INTERFACE": "*", "PRIVATE": "*", "PUBLIC": "*"}, "pargs": "*"},
                "PKGDEPS": "*",
                "PROPERTIES": {
        ...
        "check_pyoneline": {"kwargs": {"ERROR_VARIABLE": 1, "OUTPUT_VARIABLE": 1}, "pargs": "+"},
        "create_debian_binary_packages": {"kwargs": {"DEPS": "*", "OUTPUTS": "*"}, "pargs": [3, "+"]},
        ...
        "exportvars": {"kwargs": {"VARS": "+"}, "pargs": "1+", "spelling": "EXPORTVARS"},
        "format_and_lint": {"kwargs": {"CC": "*", "CMAKE": "*", "JS": "*", "PY": "*", "SHELL": "*"}},
        "get_debs": {"pargs": [3, "*"]},
        ...
        "importvars": {"kwargs": {"VARS": "+"}, "pargs": "1+", "spelling": "IMPORTVARS"},
        "join": {"kwargs": {"GLUE": 1}, "pargs": [1, "+"]},
        "pkg_find": {"kwargs": {"PKG": "*"}},
        "stage_files": {"kwargs": {"FILES": "*", "LIST": 1, "SOURCEDIR": 1, "STAGE": 1}},
        "tangent_addtest": {
            "kwargs": {
                "COMMAND": "+",
                "CONFIGURATIONS": "+",
        ...
        "tangent_unzip": {"kwargs": {"OUTPUT": "1+", "WORKING_DIRECTORY": 1}, "pargs": "1+"},
