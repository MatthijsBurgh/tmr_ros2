...
int main(int argc, char** argv)
{
  ...
  const std::shared_ptr<rclcpp::Node> node = rclcpp::Node::make_shared("demo_set_io");
  const rclcpp::Client<tm_msgs::srv::SetIO>::SharedPtr client = node->create_client<tm_msgs::srv::SetIO>("set_io");
